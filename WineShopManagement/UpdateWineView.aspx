<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateWineView.aspx.cs" Inherits="WineShopManagement.UpdateWineView" %>
    ...
    <div id="content" class="col-lg-10 col-sm-10">
        ...
        <div>
            <ul class="breadcrumb">
                ...
                <li>
                    <a runat="server" href="~/UpdateWineView">Update Wine</a>
                </li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="box-inner">
                    ...
                    <div class="box-content">
                        <div class="form-group">
                            <asp:DropDownList ID="ddl_Wine" Style="text-align: center;" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddl_Wine_SelectedIndexChanged" AutoPostBack="True">
                            </asp:DropDownList>
                        </div>
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorName" ValidationGroup="Save" runat="server" ControlToValidate="txtName" ErrorMessage="Please enter wine name" ForeColor="#993333"></asp:RequiredFieldValidator>
                        </div>
                    </div>
