<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateCustomerView.aspx.cs" Inherits="WineShopManagement.UpdateCustomerView" %>
    ...
    <div id="content" class="col-lg-10 col-sm-10">
        ...
        <div>
            <ul class="breadcrumb">
                ...
                <li>
                    <a runat="server" href="~/UpdateCustomerMaster">Update Customer</a>
                </li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="box-inner">
                    ...
                    <div class="box-content">
                        <div class="form-group">
                            <asp:DropDownList ID="ddl_Customer" Style="margin-left: auto; margin-right: auto; text-align: center;" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddl_Customer_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="exampleInputName">Select Price<span style="color: red;">*</span></label>
